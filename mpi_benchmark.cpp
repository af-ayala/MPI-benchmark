...
show_help(char *progname) {
  ...
  printf( " mpirun -n 2 ./mpi_benchmark  SEND         2000000      3 \n");
  printf( " mpirun -n 4 ./mpi_benchmark  ALLGATHER    2000000      3 \n");
  printf( " mpirun -n 4 ./mpi_benchmark  ALL2ALLV     2000000      3 \n");
  printf( " mpirun -n 4 ./mpi_benchmark  ALLREDUCE    2000000      3 \n");
  printf( " mpirun -n 2 ./mpi_benchmark  SEND_B2B     2000000      3 \n");
  printf( " mpirun -n 2 ./mpi_benchmark  SEND_BIDIR   2000000      3 \n");
  printf( " mpirun -n 2 --map-by node nvprof -fo profiler_output_%s ./mpi_benchmark SEND 2000000  1\n","%q{OMPI_COMM_WORLD_RANK}.nvvp");
  printf( " ---------------------------------------------------------------------------------------------- \n");
  printf( " Run examples - SpectrumMPI \n");
  printf( " jsrun --smpiargs=\"-gpu\" -r1 -a1 -c1 -g1 -n2 ./gpu_setter_summit.sh ./mpi_benchmark SEND   2000000 4 \n");
  printf( " jsrun --smpiargs=\"-gpu\" -a1 -c1 -g1 -n2 ./gpu_setter_summit.sh ./mpi_benchmark SEND_BIDIR 2000000 4 \n");
  printf( " jsrun --smpiargs=\"-gpu\" -a1 -c1 -g1 -n2 ./gpu_setter_summit.sh ./mpi_benchmark ALL2ALLV   2000000 4 \n");
  printf( " jsrun --smpiargs=\"-gpu\" -a1 -c1 -g1 -n2 nvprof -o $MEMBERWORK/csc301/bw.%%p.nvvp ./gpu_setter_summit.sh ./mpi_benchmark SEND 2000000 4\n");
  printf( " jsrun --smpiargs=\"-gpu\" -a1 -c1 -g1 -n2 nvprof -o $MEMBERWORK/csc301/bw.%%p.nvvp ./gpu_setter_summit.sh ./mpi_benchmark ALL2ALLV 2000000 4\n");
  printf( " Get profiler without gpu_setter (use cuda 9.1.85 to be able to see it using NVVP): \n");
  printf( " jsrun --smpiargs=\"-gpu  -x CUDA_VISIBLE_DEVICES='0,1,2,3,4,5'\" -a1 -c1 -g1 -n3 nvprof -o $MEMBERWORK/csc301/bw.%%p.nvvp ./mpi_benchmark ALL2ALLV 2000000 1\n");
  printf( " ---------------------------------------------------------------------------------------------- \n");
  printf( "  \n");
}
///////////////////////////////////////////////////////////////
